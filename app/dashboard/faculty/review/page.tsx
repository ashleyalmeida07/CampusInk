  ...
  return (
    <DashboardShell>
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Review Submissions</h2>
          <p className="text-muted-foreground">Review and endorse student submissions from your department</p>
        </div>
          ...
          <TabsContent value="reviewed" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Submissions you have already reviewed</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
        ...
        <Dialog open={actionDialogOpen} onOpenChange={setActionDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {actionType === "approve"
                  ? "This submission will be approved and sent for final verification."
